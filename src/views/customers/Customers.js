          ...
          return (
            <div className={classes.root}>
              <Grid container={true} spacing={8} justify="space-between">
                ...
                <Grid item={true} md={6}>
                <Route path="/customers/create" render={props => <CreateCustomer refetch={() => refetch()} {...props} />} />
                <Route path="/customers/:id" component={Customer} />
                <Route path="/customers/settings/:id" render={props => <EditCustomer refetch={() => refetch()} {...props} />} />
                </Grid>
              </Grid>
            </div>
          )
